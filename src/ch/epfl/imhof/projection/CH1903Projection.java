...
public final class CH1903Projection implements Projection {
    ...
    public Point project(PointGeo point) {
        ...
        double x = 600072.37 + 211455.93 * longitude1 - 10938.51 * longitude1
                * latitude1 - .36 * longitude1 * latitude1 * latitude1 - 44.54
                * Math.pow(longitude1, 3);
        double y = 200147.07 + 308807.95 * latitude1 + 3745.25 * longitude1
                * longitude1 + 76.63 * latitude1 * latitude1 - 194.56
                * longitude1 * longitude1 * latitude1 + 119.79
                * Math.pow(latitude1, 3);
    ...
    public PointGeo inverse(Point point) {
        ...
        double longitude0 = 2.6779094 + 4.728982 * x1 + 0.791484 * x1 * y1
                + 0.1306 * x1 * y1 * y1 - 0.0436 * Math.pow(x1, 3);
        double latitude0 = 16.9023892 + 3.238272 * y1 - 0.270978 * x1 * x1
                - 0.002528 * y1 * y1 - 0.0447 * x1 * x1 * y1 - 0.014
                * Math.pow(y1, 3);
