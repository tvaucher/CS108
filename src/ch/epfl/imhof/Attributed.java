...
/**
 * Immutable generic class. Represents an entity of type T associated to an
 * Attributes object e.g. a Polygon with a list of attributes.
 * 
 * @author Maxime Kjaer (250694)
 * @author Timote Vaucher (246532)
 *
 * @param <T>
 *            The type of entity of the generic object
 */
public final class Attributed<T> {
    ...
    /**
     * @see ch.epfl.imhof.Attributes#get(String, String) Returns the value to
     *      which the specified key is mapped, or defaultValue if this map
    ...
    /**
     * @see ch.epfl.imhof.Attributes#get(String, int) Returns the value to which
     *      the specified key is mapped, or defaultValue if the map contains no
     *      mapping or when the retrieved value can't be parsed.
     * 
     * @param key
     *            key whose associated value is to be returned
     * @param defaultValue
