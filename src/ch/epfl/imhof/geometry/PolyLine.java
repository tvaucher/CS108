...
/**
 * A polyline is a collection of interconnected points that may either form a
 * closed (ClosedPolyLine) or an open (OpenPolyLine) object.
 * 
...
public abstract class PolyLine {
     ...
     *             If the list of points is empty, the constructor throws an
    ...
    /**
     * The Builder class can receive data about a polyline before instantiating
     * it.
     * 
     * @author Maxime Kjaer (250694)
     * @author Timote Vaucher (246532)
